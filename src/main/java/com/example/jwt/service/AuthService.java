...
public class AuthService {
	...
	public String register(RegisterRequest request) {
		...
		User user = new User(request.name(), request.username(), passwordEncoder.encode(request.password()), "USER");
	...
	public AuthResponse login(LoginRequest request) {
		...
		String token = jwtService
				.generateToken(org.springframework.security.core.userdetails.User.builder().username(user.getUsername())
